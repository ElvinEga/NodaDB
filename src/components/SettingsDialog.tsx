...
import { useSettingsStore, Theme, FontSize } from '@/stores/settingsStore';
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[85vh] flex flex-col">
        ...
        <Tabs defaultValue="appearance" className="flex-1 overflow-hidden flex flex-col">
          ...
          {/* Appearance Tab */}
          <TabsContent value="appearance" className="flex-1 overflow-y-auto space-y-6 pt-4">
          ...
          {/* Editor Tab */}
          <TabsContent value="editor" className="flex-1 overflow-y-auto space-y-6 pt-4">
            <div className="space-y-4">
          ...
          {/* Query Tab */}
          <TabsContent value="query" className="flex-1 overflow-y-auto space-y-6 pt-4">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                ...
                <Switch checked={autoExecuteOnLoad} onCheckedChange={setAutoExecuteOnLoad} />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch checked={confirmBeforeExecute} onCheckedChange={setConfirmBeforeExecute} />
              </div>
          ...
          {/* Table Tab */}
          <TabsContent value="table" className="flex-1 overflow-y-auto space-y-6 pt-4">
            <div className="space-y-4">
              <div className="space-y-2">
